  ...
  return (
    <div className="container_as">
      ...
      <div className="opcao_estilo">
        <p>
          Ter estilo com suas roupas é expressar sua personalidade, criatividade
          e confiança, usando peças que fazem você se sentir único e bem consigo
          mesmo.
        </p>
        <button>ENCONTRE O SEU</button>
      </div>
    </div>
  );
}
